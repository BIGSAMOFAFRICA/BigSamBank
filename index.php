...
<head>
    ...
    <title>BigSamBank - Modern Online Banking</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
        <div class="container">
            <a class="navbar-brand fw-bold" href="#">
                <i class="fas fa-piggy-bank me-2"></i>BigSamBank
            </a>
    ...
    <section id="about" class="py-5">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <h2>About BigSamBank</h2>
                    <p class="lead">We’re redefining digital banking.</p>
                    <p>Founded in 2023, BigSamBank combines cutting-edge technology with personalized service. Our mission is to make financial management effortless for everyone.</p>
    ...
    <footer class="py-4 bg-dark text-white">
        <div class="container text-center">
            <p class="mb-0">&copy; 2023 BigSamBank. All rights reserved.</p>
        </div>
    </footer>
